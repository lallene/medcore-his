...
var StaffFunctionPermissions = map[string][]string{
	...
	"DIRECTEUR_MEDICAL":       {"dashboard.read", "patients:read", "patients.360.read", "medical_records.read", "consultations.read", "hospitalizations.read", "rooms.read", "beds.read", "bed_assignments.read", "laboratory.read", "imaging.read", "pharmacy.stock.read", "insurance.authorization.read", "billing.read", "organization.read", "queue.read.all", "queue.reception.read", "queue.triage.read", "queue.doctor.read", "queue.priority.update", "schedule.read.all", "schedule.manage.service", "appointment.reschedule.service", "appointment.cancel.service", "appointment.no_show.service"},
