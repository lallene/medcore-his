...
var StaffFunctionPermissions = map[string][]string{
	...
	"INFIRMIER": {
		...
		"performed_acts.read", "performed_acts.create",
		"queue.triage.read", "queue.triage.update", "queue.priority.update",
	},
	"BIOLOGISTE":  {"patients:read", "patients.360.read", "laboratory.read", "laboratory.collect", "laboratory.process", "laboratory.result.write", "laboratory.validate", "performed_acts.read", "performed_acts.create"},
	"RADIOLOGIE":  {"patients:read", "patients.360.read", "imaging.read", "imaging.schedule", "imaging.perform", "imaging.report.write", "imaging.validate", "performed_acts.read", "performed_acts.create"},
	...
	"FACTURATION": {"patients:read", "billing.read", "billing.create", "billing.issue", "billing.tariff.read", "act_catalog.read", "performed_acts.read", "insurance.authorization.read", "receivables.read", "insurance_receivables.read", "insurance_batches.read", "insurance_batches.create", "insurance_batches.submit"},
	"COMPTABLE":   {"billing.read", "billing.tariff.read", "act_catalog.read", "performed_acts.read", "cash.register.read", "cash.session.read", "cash.payment.read", "cash.receipt.read", "receivables.read", "insurance_receivables.read", "insurance_receivables.followup", "insurance_settlements.read", "insurance_settlements.create", "insurance_settlements.allocate", "insurance_batches.read"},
}
