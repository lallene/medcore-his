...
var StaffFunctionPermissions = map[string][]string{
	...
	"FACTURATION": {"patients:read", "billing.read", "billing.create", "billing.issue", "billing.tariff.read", "act_catalog.read", "insurance.authorization.read", "receivables.read", "insurance_receivables.read", "insurance_batches.read", "insurance_batches.create", "insurance_batches.submit"},
	"COMPTABLE":   {"billing.read", "billing.tariff.read", "act_catalog.read", "cash.register.read", "cash.session.read", "cash.payment.read", "cash.receipt.read", "receivables.read", "insurance_receivables.read", "insurance_receivables.followup", "insurance_settlements.read", "insurance_settlements.create", "insurance_settlements.allocate", "insurance_batches.read"},
}
